...
|---|---|---|
| `klengine-test.exe` | the keylayout-driven engine vs the macOS ground truth | run → expect **20/20** (Unicode) + **12/12** (Classic) |
| `enginetest.exe` | old hand engine (TSF IME) corpus | run → **13/13 passed** |
