...
windres tray\tray.rc -o tray\tray_res.o || goto :fail
%GXX64% -B"%B64%." -std=c++17 -O2 -static -mwindows -municode -finput-charset=UTF-8 tray\tray.cpp tray\tray_res.o engine\klengine.cpp -o dist\bangla-tray.exe -lgdi32 -luser32 -lshell32 || goto :fail
